...
public class HookPlayerController extends PlayerControllerMP {
    ...
    public HookPlayerController(Minecraft par1Minecraft, NetClientHandler par2NetClientHandler) {
    ...
    {
        if (!this.mc.thePlayer.canCurrentToolHarvestBlock(par1, par2, par3))
        {
            return false;
        }
        else
    ...
    {
		/** Pendrum. **/
		this.mc.pm.mods.handeBlockClicked(par1, par2, par3, par4);
    ...
    public void onPlayerDamageBlock(int par1, int par2, int par3, int par4)
    {
        ...
        else
        {
            if (this.func_85182_a(par1, par2, par3))
            {
                ...
                if (this.curBlockDamageMP >= (this.mc.pm.mods.miner.getState() ? 1.0F - ((Float)this.mc.pm.mods.miner.getOption("Miner_speed")).floatValue() : 1.0F))
                {
                    this.isHittingBlock = false;
    ...
    public HookEntityClientPlayer func_78754_a(World par1World)
    {
        return new HookEntityClientPlayer(this.mc, par1World, this.mc.session, this.netClientHandler);
    }
