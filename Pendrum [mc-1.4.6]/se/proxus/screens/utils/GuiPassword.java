package se.proxus.screens.utils;
...
public class GuiPassword extends Methods {
	/**
	...
	public GuiPassword(FontRenderer par1FontRenderer, int par2, int par3, int par4, int par5) {
	 ...
	 */
	 ...
	 public void drawTextBox()
	 {
		 ...
		 {
			 ScaledResolution var111 = new ScaledResolution(Minecraft.getMinecraft().gameSettings, Minecraft.getMinecraft().displayWidth, Minecraft.getMinecraft().displayHeight);
			 int var1211 = var111.getScaledWidth();
			 int var1311 = var111.getScaledHeight();
			 int var1411 = Mouse.getX() * var1211 / Minecraft.getMinecraft().displayWidth;
			 int var1611 = var1311 - Mouse.getY() * var1311 / Minecraft.getMinecraft().displayHeight - 1;
			 ...
			 if (this.getEnableBackgroundDrawing()) {
				 ...
				 //this.drawButtonRect(this.xPos + this.Rez1, this.yPos + this.Rez2, this.xPos + this.width - this.Rez3, this.yPos + this.height - this.Rez4, false);
			 }
			 ...
			 if (var4.length() > 0)
			 {
				 ...
				 var9 = this.fontRenderer.drawStringWithShadow(Pendrum.utils.appendText(var10, "*"), var7, var8, var1);
			 }
	 ...
	 public void playSound() {
		 Minecraft.getMinecraft().sndManager.playSoundFX("random.click", 1.0F, 0.6F);
	 }
}
