...
public final class ConversionHandler {
	 ...
	 * @since 1.5
	 */
	public static Object to(final Class<?> cls, final Object value, final Object... params) throws ConversionException {
	 ...
	 * @param delimiter
	 *            the events delimiter to use
	 * @return the correctly escaped string
	 */
	public static String escapeDelimiters(final String s, final char delimiter) {
	...
	/**
	 * Escapes the events delimiter if it is contained in the given string. This
	 * method ensures that events delimiter characters that are part of a
	 * property's value are correctly escaped when a parent is saved to a
	 * file. Otherwise when loaded again the property will be treated as a events
	 * property.
	 *
	 * @param s
	 *            the string with the value
	 ...
	 * @since 1.7
	 */
	public static String escapeListDelimiter(final String s,
	 ...
	 * given value contains variables of the form <code>${...}</code>. If this
	 * is the case, all occurrences will be substituted by their current values.
	 * 
	 * @param value
	 *            the value to be interpolated
	 * @return the interpolated value
	 */
	public static Object interpolate(final Object value,
