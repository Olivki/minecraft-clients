...
public class GlyphCache {
	...
	/**
	 * BlockTest the first font in the system able to render at least one
	 * character from a given string. The function always tries searching first
	 * in the fontCache (based on the request style). Failing that, it searches
	 * the usedFonts list followed by the allFonts[] array.
	 * 
	 * @param text
	...
	void cacheGlyphs(final Font font, final char text[], final int start, final int limit,
		...
		for (int index = 0; index < numGlyphs; index++) {
			 ...
			 */
			Rectangle rect = vector.getGlyphPixelBounds(index, null, -vectorBounds.x,
					-vectorBounds.y);
	...
	private void setRenderingHints() {
		stringGraphics.setRenderingHint(RenderingHints.KEY_ANTIALIASING, antiAliasEnabled
				? RenderingHints.VALUE_ANTIALIAS_ON : RenderingHints.VALUE_ANTIALIAS_OFF);
		stringGraphics.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING, antiAliasEnabled
	...
	private void allocateGlyphCacheTexture() {
		...
		textureName = GLAllocation.generateTextureNames();
