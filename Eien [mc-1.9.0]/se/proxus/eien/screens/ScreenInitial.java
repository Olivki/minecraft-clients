...
import se.proxus.eien.io.Download;
import se.proxus.eien.io.DownloadManager;
import se.proxus.eien.tools.IOTools;
...
public class ScreenInitial extends GuiScreen {
	...
	public void drawScreen(final int x, final int y, final float ticks) {
		...
		FontRenderer font = Eien.getInstance().getMinecraft().fontRendererObj;
