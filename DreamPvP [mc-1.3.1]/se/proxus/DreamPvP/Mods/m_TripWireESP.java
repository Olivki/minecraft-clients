...
public class m_TripWireESP extends Base_Mod implements Renderer {
	...
	public m_TripWireESP() {
		super('7', "TripWire_ESP", "Draws a box around tripwire.", KEY_NONE, "World", "[§eW§r] ");
	...
	public void onRendered() {
		...
		for(int cur = 0; cur < espSize; cur++) {
			if(espBlock[cur].id == id) {
				...
				//dp.render.drawSphere((double)col1, (double)col2, (double)col3, 1.0D, x - playerX, y - playerY, z - playerZ, 0.5F, 20, 20, 1.0F);
				//dp.render.drawTag(dp.utils.getDistance("Tripwire", dp.mc.thePlayer, x, z), x, y, z);
			}
		}
	}
