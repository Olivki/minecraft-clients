...
public class cGuiIngame extends GuiIngame {
    ...
    public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
    {
        ...
        if (!this.mc.playerControllerMP.func_78747_a())
        {
            ...
            if (this.mc.playerControllerMP.shouldDrawHUD())
            {
                var18 = var6 / 2 - 91;
                var19 = var6 / 2 + 91;
        ...
        if (this.mc.playerControllerMP.func_78763_f() && this.mc.thePlayer.experienceLevel > 0)
        {
        ...
        if (this.mc.gameSettings.showDebugInfo)
        {
        	...
        	mc.dp.ingame.drawOverlay(par3, par4, par1);
        }
