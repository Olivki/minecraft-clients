...
public class WorldSettingsGui extends GuiScreen {
	
	public GuiScreen parentScreen;
	public WorldSettings worldSettings;
	
	public WorldSettingsGui(GuiScreen parentScreen) {
		this.parentScreen = parentScreen;
		this.worldSettings = new WorldSettings(mc.theWorld.getWorldInfo());
	}
	...
	public void initGui() {	
		this.worldSettings = new WorldSettings(mc.theWorld.getWorldInfo());
		controlList.clear();
		controlList.add(new GuiButton(0, width / 2 - 100, height / 4 + 24, 98, 20, "Cheats : " + worldSettings.areCommandsAllowed()));
	...
	public void drawScreen(int I1, int I2, float I3) {
		...
		drawCenteredString(fontRenderer, "World settings.", width / 2, 50, 0xFFFFFFFF);
