package se.proxus.DreamPvP.Gui.Screens.Utils;
...
public class PassField extends Methods {
    /**
    ...
    public PassField(FontRenderer par1FontRenderer, int par2, int par3, int par4, int par5) {
        text = "";
        maxStringLength = 32;
    ...
    public void drawTextBox()
    {
        ...
        String s = fontRenderer.trimStringToWidth(DreamPvP.utils.replaceStar(text.substring(field_73816_n)), getWidth());
