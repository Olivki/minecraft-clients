...
public class h_EntityClientPlayerMP extends EntityClientPlayerMP {
	...
	public h_EntityClientPlayerMP(Minecraft par1Minecraft, World par2World, Session par3Session, NetClientHandler par4NetClientHandler) {
	...
	public void sendMotionUpdates() {
		...
		this.mc.main.hacks.onPostMotion();
	}
	...
	public void sendChatMessage(String var1) {
		if(var1.charAt(0) == '-') {
			this.mc.main.cmds.runCommands(var1.substring(1));
			return;
		} else {
