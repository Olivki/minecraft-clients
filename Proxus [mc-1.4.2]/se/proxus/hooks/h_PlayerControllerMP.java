...
public class h_PlayerControllerMP extends PlayerControllerMP {
    ...
    public h_PlayerControllerMP(Minecraft par1Minecraft, NetClientHandler par2NetClientHandler) {
    ...
    public void onPlayerDamageBlock(int par1, int par2, int par3, int par4)
    {
        ...
        else
        {
            if (par1 == this.currentBlockX && par2 == this.currentBlockY && par3 == this.currentblockZ)
            {
                ...
                if (this.curBlockDamageMP >= (mc.main.hacks.HACK_MINER.getState() ? 1.0F - ((Float)mc.main.hacks.HACK_MINER.getOption(Base_Options.MINE_SPEED)).floatValue() : 1.0F))
                {
                    this.isHittingBlock = false;
                    this.netClientHandler.addToSendQueue(new Packet14BlockDig(2, par1, par2, par3, par4));
                    this.onPlayerDestroyBlock(par1, par2, par3, par4);
                    ...
                    this.prevBlockDamageMP = 0.0F;
                    this.stepSoundTickCounter = 0.0F;
                    this.blockHitDelay = ((Integer)mc.main.hacks.HACK_MINER.getOption(Base_Options.MINE_DELAY)).intValue();
                }
    ...
    public h_EntityClientPlayerMP func_78754_a(World par1World)
    {
        return new h_EntityClientPlayerMP(this.mc, par1World, this.mc.session, this.netClientHandler);
    }
