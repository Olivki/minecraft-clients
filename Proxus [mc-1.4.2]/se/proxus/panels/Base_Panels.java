...
import se.proxus.panels.panels.setup.*;
...
public class Base_Panels extends GuiScreen {
	...
	public void keyTyped(char var1, int var2) {
		...
		try {
			for(Base_Panel var3 : this.panelArray) {
	...
	public void init() {
		...
		this.addPanel(world = new p_World());
