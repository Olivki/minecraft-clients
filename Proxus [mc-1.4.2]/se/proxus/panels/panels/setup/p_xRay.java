...
public class p_xRay extends Base_Panel {
	
	public u_Textfield
	colour = null;

	public p_xRay() {
		super("xRay setup", 1, 1);

		this.addUtil(colour = new u_Textfield("Colour", "" + this.hacks.HACK_XRAY.getCol(), this.x2 - 4, this, false, 0, "Changes the hacks colour."));
		this.addUtil(new u_Slider("Brightness", this.hacks.HACK_XRAY, Base_Options.XRAY_BRIGHTNESS, 20D, this.x2 - 4));
	}
