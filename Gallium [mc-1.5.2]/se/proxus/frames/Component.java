...
public interface Component {
     ...
     */
    public void draw(FontFactory font, int x, int y, float ticks);

    /**
     * The method for running things if the component has been pressed.
     * 
     * @param x
     *            The X coordinate of the mouse.
     * @param y
    ...
    /**
     * The method for checking if a certain key has been typed.
     * 
     * @param keyName
     *            The name of the key.
     * @param keyChar
