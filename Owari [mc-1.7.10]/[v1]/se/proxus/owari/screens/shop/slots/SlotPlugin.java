...
public class SlotPlugin extends GuiSlot {
	...
	@Override
	protected void drawSlot(final int selected, final int var1, final int var2, final int var3,
			final Tessellator p_148126_5_, final int p_148126_6_, final int p_148126_7_) {
		FontRenderer font = Client.getInstance().getMinecraft().fontRenderer;
		int mouseX = field_148150_g;
		int mouseY = field_148162_h;
		String[] pluginInfo = { "The Final Solution", "Hitler", "19,50", "Third Reich" };
		pluginInfo = guiScreen.getPluginOnline().getPluginInfo(selected);
		guiScreen.drawCenteredString(font, pluginInfo[0].replace("@", " "), guiScreen.width / 2,
				var2 + 1, 0xFFFFAA00);
		guiScreen.drawString(font, "Author(s): " + pluginInfo[1], var1 + 1, var2 + 11, 0xFF808080);
		guiScreen.drawString(font, "Version: " + pluginInfo[2].replace(",", "."), var1 + 1,
				var2 + 21, 0xFF808080);
		...
		drawProgressBar(var1 + 2, var2 + 42, var1 + func_148139_c() - 6, var2 + 48,
				progressInteger, font);
	}
