...
public class m_Player extends WindowBase {
	...
	public void drawScreen(int i, int j, float f) {
		...
		//font.drawStringWithShadow("Player", dragX + 2, dragY + 1, 0xFFFFFFFF);
		drawSmallTTFString2("Player", dragX + 1, dragY - 4);

		if(enabled) {
			drawBorderedRect(dragX, dragY + 11, dragX + 106, dragY + 87, 0xFF000000, 0x500E0E0E);
			drawButton(dragX, dragY + 9, "Sneak", mc.comet.keys.sneak.isRunning(), i, j, true, "Makes your character sneak.", sW("Makes your character sneak.") - 67);
	...
	public void mouseClicked(int i, int j, int k) {
		...
		if(enabled) {
			if(i > dragX + 72 && i < dragX + 104 && j > dragY + (9 + 4) && j < dragY + (12 + 12)) {mc.comet.keys.sneak.toggle(); playSound();}
