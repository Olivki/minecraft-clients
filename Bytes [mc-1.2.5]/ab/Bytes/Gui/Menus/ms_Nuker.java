...
public class ms_Nuker extends Base_Menu {
	...
	protected void checkButtons() {
		...
		buttons.add(new Base_Label(0, "Nuker", dragX, dragY, enabled, buttons, 22));
		buttons.add(new Base_SmallButton(1, dragX + 80, dragY + 2, enabled));
		buttons.add(new Base_SmallButton(2, dragX + 69, dragY + 2, pinned));

		if(enabled) {
			buttons.add(new Base_Button(3, "Smasher", dragX, dragY + 15, mList.smasher.isEnabled()));
			buttons.add(new Base_Button(4, "Survival nuker", dragX, dragY + 30, mList.survivalnuker.isEnabled()));
			buttons.add(new Base_Button(5, "Creative nuker", dragX, dragY + 45, mList.creativenuker.isEnabled()));
		}
	}
	...
	protected void buttonClicked(Base_Button button, int I1, int I2) {
		...
		case 3 : {mList.smasher.toggle(); {break;}}
		case 4 : {mList.survivalnuker.toggle(); {break;}}
		case 5 : {mList.creativenuker.toggle(); {break;}}
		}
	}
