...
public class PasswordField extends Gui
{
    ...
    private String stringToChar(String s)
    {
    	String h="";
    ...
    public void drawTextBox()
    {
        ...
        if (s.length() > 0)
        {
            ...
            j1 = fontRenderer.drawStringWithShadow(stringToChar(s1), j1, i1, i);
        }
        ...
        {
            j1 = fontRenderer.drawStringWithShadow(stringToChar(s).substring(j), j1, i1, i);
        }
