...
public abstract class Base_Command extends GodlikeCraft {
	...
	protected void addSyntax(String var1) {
		console.addMessage("§cSyntax§f : " + var1);
	}
	...
	protected void addToggle(String var1, boolean var2) {
		console.addMessage(var1 + " : " + (var2 ? "§aEnabled§f" : "§cDisabled§f") + ".");
	}
