...
public class GuiPassword extends Gui {
    ...
    public void drawTextBox()
    {
        ...
        {
			ScaledResolution var111 = new ScaledResolution(Minecraft.theMinecraft.gameSettings, Minecraft.theMinecraft.displayWidth, Minecraft.theMinecraft.displayHeight);
			int var1211 = var111.getScaledWidth();
			int var1311 = var111.getScaledHeight();
			int var1411 = Mouse.getX() * var1211 / Minecraft.theMinecraft.displayWidth;
			int var1611 = var1311 - Mouse.getY() * var1311 / Minecraft.theMinecraft.displayHeight - 1;
            ...
            if (var4.length() > 0)
            {
                ...
                var9 = this.fontRenderer.drawStringWithShadow(GodlikeCraft.utils.appendText(var10, "*"), var7, var8, var1);
            }
